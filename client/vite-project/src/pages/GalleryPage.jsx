...
import { usePokemonGallery } from "../hooks/usePokemonGallery.js"; // ⏸️ WORKSHOP STEP 4: Use Custom Hook
...
const { data, loading, error, refetch } = usePokemonGallery();
  // ⏸️ WORKSHOP STEP 6: Add useMemo for Sortingconst [sortBy, setSortBy] = useState("newest");
...
const like = async (id) => {
  try {
    ...
    await refetch(); // Refresh the gallery after liking
